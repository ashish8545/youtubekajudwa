        ...
        <div className="px-20 py-4 m-4 overflow-y-auto w-full">
            {
                videos.map((video) => 
                    <Link to={"/watch?v=" + video?.id}>
                        <div className="grid grid-cols-12 pb-8 cursor-pointer" key={video?.id}>
                            <div className="col-span-5">
                                <div className="h-[350px]">
                                    ...
                                    <img className="rounded-2xl w-full h-full object-cover" alt="Video Thumbnail" src={video?.snippet?.thumbnails?.high?.url} />
                                </div>
                            </div>
