...
export const YOUTUBE_ALL_VIDEOS_API_URL="https://youtube.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics%2CliveStreamingDetails&chart=mostPopular&maxResults=48&regionCode=" + REGION_CODE + "&key=" + YOUTUBE_API_KEY;
